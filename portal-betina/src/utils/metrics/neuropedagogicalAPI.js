...
class NeuropedagogicalAPIService {
  constructor() {
    const envSchema = z.object({
      ...
      VITE_API_TIMEOUT: z.coerce.number().min(5000).default(15000),
      VITE_API_RETRY_ATTEMPTS: z.coerce.number().min(0).max(5).default(3),
      VITE_BATCH_SIZE: z.coerce.number().min(10).max(100).default(50),
      VITE_COMPRESSION_ENABLED: z.coerce.boolean().default(true),
      ...
      VITE_API_KEY: z.string().min(1).default('dev-betina-api-key-2024'),
    })
