...
export class SessionAnalyzer {
  ...
  calculateAccuracyImprovement(performance) {
    ...
    return performance.previousAccuracy ? performance.accuracy - performance.previousAccuracy : 0
  }
  ...
  calculatePerformanceVariability(performance) {
    ...
    return performance.responses ? this.calculateStandardDeviation(performance.responses) : 0
  }
