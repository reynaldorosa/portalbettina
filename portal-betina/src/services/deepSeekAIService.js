...
class DeepSeekAIService {
  constructor() {
    ...
    this.baseUrl = import.meta.env.VITE_DEEPSEEK_API_URL || 'https://api.deepseek.com'
    this.model = import.meta.env.VITE_DEEPSEEK_MODEL || 'deepseek-chat'
    this.maxRetries = parseInt(import.meta.env.VITE_DEEPSEEK_MAX_RETRIES) || 3
    this.retryDelay = parseInt(import.meta.env.VITE_DEEPSEEK_RETRY_DELAY_MS) || 1000
    this.timeout = parseInt(import.meta.env.VITE_DEEPSEEK_TIMEOUT_MS) || 30000
    this.temperature = parseFloat(import.meta.env.VITE_DEEPSEEK_TEMPERATURE) || 0.7
    this.maxTokens = parseInt(import.meta.env.VITE_DEEPSEEK_MAX_TOKENS) || 4096
