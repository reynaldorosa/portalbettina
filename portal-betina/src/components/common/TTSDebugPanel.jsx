...
import { getTTSStatus, enableDebug } from '../utils/ttsDebug';
import { isTTSEnabled, setTTSEnabled } from '../utils/ttsManager';
    ...
    <Container>
      ...
      <div>
        <Button onClick={toggleDebug}>
          {isDebugging ? 'Desativar Debug' : 'Ativar Debug'}
        </Button>
        
        <Button onClick={toggleTTS}>
          {status.ttsSetting ? 'Desativar TTS' : 'Ativar TTS'}
        </Button>
